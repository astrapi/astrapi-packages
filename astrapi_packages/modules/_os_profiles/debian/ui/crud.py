"""astrapi_packages.modules._os_profiles.debian.ui.crud – FastAPI-UI-Router für das Debian-Modul."""
...
from astrapi_packages.modules._os_profiles.debian import KEY, store
